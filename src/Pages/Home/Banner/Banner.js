    ...
    return (
        <div className="hero ">
            <div className="hero-content flex-col lg:flex-row-reverse">
                <img src="https://www.greenhavenpediatricdentistry.com/wp-content/uploads/little-girl-getting-dental-exam.jpg" alt='sd' className="rounded-lg w-1/2 shadow-2xl" />
                <div>
